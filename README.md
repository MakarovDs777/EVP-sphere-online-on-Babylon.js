...
ЭГФ сфера при нажатие на которую происходит генерация звука случайного байта от 0 до 255.

[EVP sphere on Babylon.js (Version 0 - BYTE LETTERS EVP SPHERE) | Babylon.js Playground](https://playground.babylonjs.com/#7C40KS)
